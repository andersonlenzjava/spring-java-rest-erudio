package br.com.erudio.springjavaerudio.model.security;
...
public class User implements UserDetails, Serializable {
    ...
    // tabela com uma lista de permissões (esquisito ao meu ver mas tudo bem)
    // estudar em cada caso qual é melhor de ser implementado o fetchType
    ...
    // é uma quebra de conveção, mas é implementado por causa da user details
